...
public class AddGuestContactAdapter extends RecyclerView.Adapter<AddGuestContactAdapter.ContactHolder>
{
    ...
    public AddGuestContactAdapter(List<Contact> contactList, Context context) {
        this.contactList = contactList;
        this.inflater = LayoutInflater.from(context);
    }

    @Override
    public AddGuestContactAdapter.ContactHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.select_contact_item, parent, false);
        return new AddGuestContactAdapter.ContactHolder(v);
    }

    @Override
    public void onBindViewHolder(AddGuestContactAdapter.ContactHolder holder, int position) {
